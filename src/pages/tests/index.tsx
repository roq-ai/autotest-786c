...
import { getTests, deleteTestById } from 'apiSdk/tests';
...
export function TestListPage(props: TestListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<TestInterface>>(
    () => `/tests?params=${JSON.stringify(params)}`,
    fetcher,
  );
