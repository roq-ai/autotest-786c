        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Total Bug Fixes" text={data?.total_bug_fixes} />

                <FormListItem label="Pending Tests" text={data?.pending_tests} />

                <FormListItem label="Running Tests" text={data?.running_tests} />
