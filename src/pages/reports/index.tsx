...
export function ReportListPage(props: ReportListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'total_bug_fixes', header: 'total_bug_fixes', accessorKey: 'total_bug_fixes' },
    { id: 'pending_tests', header: 'pending_tests', accessorKey: 'pending_tests' },
    { id: 'running_tests', header: 'running_tests', accessorKey: 'running_tests' },
